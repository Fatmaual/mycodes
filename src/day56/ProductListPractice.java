...
public class ProductListPractice {
    public static void main(String[] args) {
        ...
        //sony tv with 499 listemizde var mi check yap
  ...
  //  for(Product each:productList){
   ...
   // }
        ...
        System.out.println("has Sony TV, with 499 or not result is: "+result1);

        boolean result2= productList.contains(new Product("Apple TV",1499));
        System.out.println("has Sony TV, with 1499 or not result is: "+result2);
