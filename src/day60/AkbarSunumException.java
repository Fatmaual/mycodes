...
public class AkbarSunumException {
    /**
     *Exception :
     ...
     * It accidentally involve the scanner.nextLine() trouble , so we will just skip it.
     * and yet if you want to get it right above is the solution.
     * Exception :
     *     scan.nextInt() -->> expect number
     *     if we pass String --->> execption at run time
     *     str.charAt(100)  --->> execption at run time
