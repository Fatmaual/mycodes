 ...
 */
 public class MovieNight {
    ...
    public static void main(String[] args) {
      ...
      // Movie n =new Movie(null,null,"Family");
        //System.out.println(n.getName()+""+n.getLength()+""+n.getGenre().equalsIgnoreCase("Family"));
    ...
    public static void printMovieInformation(Movie movieObj) {
        ...
        //expected to print the movie Joker is 2.2 hour long and it genre is drama
        System.out.println("the movie "+movieObj.getName()+" is "+movieObj.getLength()+" hour long and it's genre is "
                +movieObj.getGenre());
    ...
    public static void printMovieNameCharacters(Movie movieObj) {
       ...
       String getChrs= "";
        for (int x = 0; x <movieObj.getName().length() ; x++) {
            if(x!=movieObj.getName().length()-1){
                getChrs+=movieObj.getName().charAt(x)+"-";
            }else{
                getChrs+=movieObj.getName().charAt(x);
            }
        }
        System.out.println(getChrs.toUpperCase());
    }
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        //TODO YOUR CODE HERE
        System.out.println(movieObj1.getName()+" is "+movieObj1.getLength()+" hours , "+movieObj2+" is "+
                movieObj2.getLength()+" hours ");
        if(movieObj1.getLength()<movieObj2.getLength()){
            System.out.println("The shorter movie is : "+movieObj1.getName() );
        }else{
            System.out.println("The shorter movie is : "+movieObj2.getName());
        }
    }
    ...
    public static boolean isFamilyMovie(Movie movieObj) {
        //TODO YOUR CODE HERE
       // return (movieObj.getGenre().equalsIgnoreCase("Family") ? true :false);
 if(movieObj.getGenre().equalsIgnoreCase("Family")){
  ...
  return false;
    ...
    public static String getCombinedMovieInfo(Movie movieObj) {
        ...
        //TODO YOUR CODE HERE
   if(movieObj.getName().equalsIgnoreCase("Joker") && movieObj.getLength()==2.2 &&
           movieObj.getGenre().equalsIgnoreCase("Drama")){
    ...
    public static Movie createFamilyMovie(String name, double len) {
        //TODO YOUR CODE HERE
      Movie n= new Movie(name, len, "Family");
        return n;
    }
    ...
    public static List<Movie> getMyFavoriteMovies() {
        ...
        //TODO YOUR CODE HERE
 movieLst.add(new Movie("Titanic",2.5,"Romantic"));
 movieLst.add(new Movie("Babam ve Oglum",2,"Drama"));
        return movieLst;
    }
